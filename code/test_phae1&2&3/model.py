...
class Prediction(torch.nn.Module):
    def __init__(self, ndim_driver):
        ...
        self.nc1 = NetConv(24, 22, 24)
        self.nc2 = NetConv_Swi(24, 22, 24)
        self.nc3 = NetConv_Swi(24, 22, 24)
    ...
    def forward(self, g, freq, util):
        ...
        x_swi_final = torch.mean(x_swi, dim=1) * (0.9 + torch.sigmoid(dri_sca)/5)

        return x_swi_final, x_swi, e, e_input